function [hover] = calc_hover(sysMass, motorNum)

thrustReq = sysMass*9.81/4;
...
hover=call_qprop(velStr, rpmStr, voltStr, dBetaStr, thrustStr, torqueStr, ampsStr, peleStr, mode,motorNum);
